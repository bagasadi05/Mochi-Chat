...
export class AudioStreamer {
  ...
  private initialBufferTime: number = 2.0; // Meningkatkan buffer awal untuk menahan fluktuasi jaringan
  ...
  private scheduleNextBuffer() {
    const SCHEDULE_AHEAD_TIME = 2.5; // Menjadwalkan lebih jauh ke depan untuk pemutaran yang lebih lancar
